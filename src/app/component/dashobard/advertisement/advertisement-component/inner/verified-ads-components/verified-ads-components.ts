...
import { ViewVerifiedAd } from './inner-items/view-verified-ad/view-verified-ad';
import { BoostAdvertisement } from './inner-items/boost-advertisement/boost-advertisement';

@Component({
  selector: 'app-verified-ads-components',
  imports: [
    MatTable,
    MatPaginator,
    FormsModule,
  ...
  templateUrl: './verified-ads-components.html',
  standalone: true,
  styleUrls: ['./verified-ads-components.scss']
})
export class VerifiedAdsComponents implements OnInit, AfterViewInit, OnDestroy {
