...
import {ComplaintService ,ComplaintRequestDTO} from '../../../../../../service/complains/complaint-service';
...
export class AllComplaintsComponent implements OnInit, OnDestroy {
  ...
  loadAll(): void {
    ...
    this.complaintService.searchComplaints(this.searchText, this.page, this.size).subscribe({
      next: (response) => {
  ...
  createComplaint(): void {
    const complaintData: ComplaintRequestDTO = {
      message: " 3This is a test complaint about the advertisement. The product was not as described.",
      generalAdId: "4ea1a183-eff9-44b9-bcde-56658462ef0e"
    };
